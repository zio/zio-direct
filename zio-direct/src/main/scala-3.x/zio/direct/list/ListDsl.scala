...
object select extends deferCall[[R, E, A] =>> List[A], List[?], Nothing, Nothing, ListMonadModel](listMonadSuccess, None, listMonadSequence, listMonadSequencePar, None, None)
